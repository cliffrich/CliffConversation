	...
	static {
		...
		guestInfo.put("wifi",
				"<speak>"
						...
						+ "Have you got your pen and paper?<break time=\"5s\" Please note all letters in the password are in capitals/>"
						+ "<say-as interpret-as=\"spell-out\">8TR<break time=\"3s\"/>3K<break time=\"3s\"/>3K<break time=\"3s\"/>T</say-as>."
